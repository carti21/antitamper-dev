    ...
    const fetchData = async () => {
      try {
        ...
        deviceRes.data.results.docs.forEach((device: Device) => {
          const region = device.factory_name || "Unknown Factory";
  ...
  return (
    <div className="space-y-6">
      ...
      <Card className="flex-1">
        <CardHeader>
          <CardTitle className="text-md">Devices per Factory</CardTitle>
          <h6 className="text-sm">Active vs Inactive by Factory</h6>
        </CardHeader>
        <CardContent>
