  ...
  return (
    ...
    >
      ...
      <div className="flex-1 flex flex-col pt-5 pb-4 overflow-y-auto">
        <div
          className={cn("hidden lg:flex items-center px-4", {
        ...
        <div className="px-4 py-3 text-white text-xs text-center border-t border-white/20 mt-auto">
          <div className="space-y-1">
            <Link to="/versions" className="">
              <h6 className="font-semibold text-sm text-center hover:underline hover:text-green-700">
                Version Info
              </h6>
            </Link>
          </div>
